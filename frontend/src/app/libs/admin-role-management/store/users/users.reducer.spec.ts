import { UsersActions, LoadUsers, LoadUsersSuccess, LoadUsersFail } from './users.actions';
...
describe('Users Reducer', () => {
	...
	describe('LoadUsersFail', () => {
		beforeEach(() => {
			usersEerror = new Error('error');
			action = new LoadUsersFail(usersEerror) as UsersActions;
			result = usersReducer(initialState, action);
		});
