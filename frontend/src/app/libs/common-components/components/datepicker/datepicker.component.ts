import { Component, Input, ChangeDetectionStrategy, Output, EventEmitter, OnInit, ElementRef, Optional, Host, SkipSelf, forwardRef, ChangeDetectorRef, OnDestroy, AfterViewInit } from '@angular/core';
import { MAT_DATE_FORMATS, DateAdapter } from '@angular/material/core';
import { AppDateAdapter, APP_DATE_FORMATS } from './dateadapter';
import { ControlValueAccessor, FormControl, ValidatorFn, ControlContainer, FormGroup, NG_VALUE_ACCESSOR, AsyncValidatorFn, ValidationErrors } from '@angular/forms';
...
export class DatepickerComponent implements ControlValueAccessor, OnInit, OnDestroy, AfterViewInit {
